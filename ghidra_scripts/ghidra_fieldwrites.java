            ...
            for (int op = 0; op < n; op++) {
                ...
                for (Object o : ops) {
                    if (o instanceof Scalar) {
                        if (((Scalar) o).getValue() == fieldOff) hasDisp = true;
                    }
                }
                if (!hasDisp) continue;
                RefType rt = i.getOperandRefType(op);
                if (rt.isWrite()) {
